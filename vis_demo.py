...
json_file='./output/OCHuman/transpose_h/H0_en6/results/keypoints_ochuman_coco_format_test_range_0.00_1.00.json_results_0.json'
imgset_path='/media/ming-t/F83438063437C702/datasets/OCHuman/images'
out_path='./vis_out'
